...
var Clock = React.createClass({displayName: "Clock",
    ...
    render: function(){
        return (
            React.createElement("h1", {className: "text-center wall-clock"}, $.format.date(this.state.time, 'HH:mm:ss'))
        );
    }
});
    ...
    render: function(){
        ...
        return (
            React.createElement("div", {className: "bell"}, 
                React.createElement("audio", {ref: "audio", loop: true}, 
                ...
                React.createElement("div", {className: "form-inline"}, 
                    ...
                    React.createElement("button", {className: "btn btn-default", onClick: this.handlePlay}, "Preview"), 
                    React.createElement("button", {className: "btn btn-danger", onClick: this.handleStop}, "Stop")
                )
            )
        );
    }
...
var AlarmEntry = React.createClass({displayName: "AlarmEntry",
    enable: function(){
...
var AlarmDigit = React.createClass({displayName: "AlarmDigit",
    ...
    render: function(){
        ...
        return (
            React.createElement("div", {className: "alarmDigit alarm-digit"}, 
                React.createElement("button", {className: "increase btn btn-default", onMouseDown: this.handleStartIncrease, onMouseUp: this.handleStopIncrease}, React.createElement("span", {className: "glyphicon glyphicon-menu-up", "aria-hidden": "true"})), 
                ...
                React.createElement("button", {className: "decrease btn btn-default", onMouseDown: this.handleStartDecrease, onMouseUp: this.handleStopDecrease}, React.createElement("span", {className: "glyphicon glyphicon-menu-down", "aria-hidden": "true"}))
            )
        );
    }
});
...
var Alarm = React.createClass({displayName: "Alarm",
    ...
    render: function(){
        var date = new Date();
        return (
            React.createElement("div", {className: "alarm"}, 
                React.createElement(Clock, null), 
                React.createElement("div", {className: "alarm-container"}, 
                    React.createElement("div", {className: "alarm-digits"}, 
                    ...
                    React.createElement("div", {className: "form-inline text-center comment"}, 
                        React.createElement("input", {className: "form-control", type: "text", ref: "comment", placeholder: "Leave your comment...", ref: "comment"}), 
                        React.createElement("button", {className: "btn btn-default", type: "button", onClick: this.handleAddAlarm}, React.createElement("span", {className: "glyphicon glyphicon-plus", "aria-hidden": "true"}))
                    ), 
